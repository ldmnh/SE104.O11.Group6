...
VALUES
    ('Vietcombank', 'Dông Sài Gòn', '1111222233334444', 'LE HIEU',   1),
...
VALUES
    ...
    ('hotel',       5,  'acc003.jpg', 'LARA HOTEL LONG XUYEN',    'Đem đến sự chất lượng tuyệt đối cho bạn.',  'Khách sạn bình dị có nhà hàng.', '46-48 Đường Hùng Vương',   6,     6,  'https://maps.app.goo.gl/uoso2HmZ4hM9uEpS9'),
