...
VALUES ('bnk000000001', 'Bank A', 'Branch A', '1111222233334444', 'John Doe', 'usr000000001'),
       ...
       ('bnk000000003', 'Bank B', 'Branch B', '5555666677778888', 'Jane Smith', 'user000000002'),
GO

INSERT INTO DebitCard (debit_id, debit_num, debit_end_date, debit_CCV, debit_name, debit_address, debit_postal, au_user_id)
VALUES ('deb000000001', '1111222233334444', '2023-12-31 23:59:59', '123', 'John Doe', '123 Main Street', '12345', 'user000000001'),
       ('deb000000002', '9999111111112222', '2025-03-31 23:59:59', '789', 'Mike Johnson', '789 Oak Street', '54321', 'user000000003'),
       ('deb000000003', '9999888811112222', '2025-03-31 23:59:59', '789', 'Mike Johnson', '789 Oak Street', '54321', 'user000000003');
GO
...
VALUES ('cty000000001', 'Thành phố Hồ Chí Minh',    'prov000000001'),
       ('cty000000003', 'Thành phố Đà Nẵng',        'prov000000003'),
       ('cty000000004', 'Thành phố Hải Phòng',      'prov000000004'),
       ('cty000000005', 'Thành phố Cần Thơ',        'prov000000005'),
       ('cty000000006', 'Thành phố Vũng Tàu',       'prov000000006');
GO
...
VALUES
    ('boo000000001', '2023-10-27 10:00:00', '2023-11-01 14:00:00', '2023-11-05 11:00:00', 'pay001', 0, 'John',       'Doe',      'john@example.com',     'usr000000001', '1234567890', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000002', '2023-10-28 11:30:00', '2023-11-02 12:00:00', '2023-11-03 10:00:00', 'pay002', 0, 'Jane',       'Smith',    'jane@example.com',     'usr000000002', '9876543210', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000003', '2023-10-29 09:15:00', '2023-11-04 15:00:00', '2023-11-06 12:00:00', 'pay003', 0, 'Michael',    'Johnson',  'michael@example.com',  'usr000000003', '5555555555', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000004', '2023-10-30 14:45:00', '2023-11-07 13:00:00', '2023-11-08 09:00:00', 'pay001', 0, 'Emily',      'Brown',    'emily@example.com',    'usr000000001', '1111111111', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000005', '2023-10-31 16:30:00', '2023-11-09 10:00:00', '2023-11-11 17:00:00', 'pay002', 0, 'David',      'Wilson',   'david@example.com',    'usr000000002', '9999999999', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000006', '2023-11-01 12:00:00', '2023-11-12 14:30:00', '2023-11-15 11:00:00', 'pay001', 0, 'Sarah',      'Jackson',  'sarah@example.com',    'usr000000003', '7777777777', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000007', '2023-11-02 10:30:00', '2023-11-16 09:00:00', '2023-11-18 12:00:00', 'pay002', 0, 'Robert',     'Anderson', 'robert@example.com',   'usr000000001', '2222222222', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000008', '2023-11-03 15:15:00', '2023-11-19 11:30:00', '2023-11-21 10:00:00', 'pay003', 0, 'Olivia',     'Thomas',   'olivia@example.com',   'usr000000002', '8888888888', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000009', '2023-11-04 11:45:00', '2023-11-22 14:00:00', '2023-11-24 09:30:00', 'pay001', 0, 'Daniel',     'Martinez', 'daniel@example.com',   'usr000000003', '4444444444', NULL, 0, 'Đã sử dụng', 1, NULL),
    ('boo000000010', '2023-11-05 09:00:00', '2023-11-25 10:30:00', '2023-11-27 12:00:00', 'pay002', 0, 'Sophia',     'Garcia',   'sophia@example.com',   'usr000000001', '6666666666', NULL, 0, 'Đã sử dụng', 1, NULL);
GO
...
VALUES
    ...
    ('usr000000004', 'roo000000004', '2023-10-30 16:15:00', 'The staff was friendly and helpful.', 4.8),
    ('usr000000005', 'roo000000005', '2023-10-31 13:30:00', 'The room was spacious and well-maintained.', 4.7);
GO
