...
SearchModel.filterSort = function (req, res, callback) {
  ...
  if (rating_point == "9+") sql += ` AND rating_point BETWEEN 9 AND 10`;
  if (rating_point == "8+") sql += ` AND rating_point BETWEEN 8 AND 9`;
  if (rating_point == "7+") sql += ` AND rating_point BETWEEN 7 AND 8`;
  if (rating_point == "6+") sql += ` AND rating_point BETWEEN 6 AND 7`;
  ...
  if (cost == "Thấp đến cao") sql += ` ORDER BY room_cost ASC`;
  if (accoStar == "Cao đến thấp") sql += ` ORDER BY acco_star DESC`;
  if (accoStar == "Thấp đến cao") sql += ` ORDER BY acco_star ASC`;
  if (countRating == "Cao đến thấp") sql += ` ORDER BY room_sum_rating DESC`;
  if (countRating == "Thấp đến cao") sql += ` ORDER BY room_sum_rating ASC`;
